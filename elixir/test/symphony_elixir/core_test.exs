defmodule SymphonyElixir.CoreTest do
  ...
  test "current WORKFLOW.md file is valid and complete" do
    ...
    assert Map.get(hooks, "after_create") =~ "PROJECT_REPO"
    assert Map.get(hooks, "after_create") =~ ".symphony/hooks/setup.sh"
    assert Map.get(hooks, "before_remove") =~ ".symphony/hooks/teardown.sh"
